...
@JsonObject('TrailingStopLossDetails')
export class TrailingStopLossDetails {
  ...
  setTimeInForce(timeInForce: TimeInForce): TrailingStopLossDetails {
  ...
  setGtdTime(gtdTime: DateTime | string): TrailingStopLossDetails {
  ...
  copy(): TrailingStopLossDetails {
    return new TrailingStopLossDetails()
