...
@JsonObject('GuaranteedStopLossDetails')
export class GuaranteedStopLossDetails {
  ...
  setPrice(
    averagePrice: PriceValue | Decimal | string
  ...
  setDistance(
    distance: DecimalNumber | Decimal | string
  ): GuaranteedStopLossDetails {
  ...
  setTimeInForce(timeInForce: TimeInForce): GuaranteedStopLossDetails {
  ...
  setGtdTime(gtdTime: DateTime | string): GuaranteedStopLossDetails {
  ...
  copy(): GuaranteedStopLossDetails {
    return new GuaranteedStopLossDetails()
