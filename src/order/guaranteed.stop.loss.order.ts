...
@JsonObject('GuaranteedStopLossOrder')
export class GuaranteedStopLossOrder implements Order {
  @JsonProperty('id', OrderIdJsonConverter, true)
  private id: OrderID = new OrderID('');
  @JsonProperty('type', String, true)
  private type: OrderType = OrderType.GUARANTEED_STOP_LOSS;
  ...
  setId(id: OrderID | string): GuaranteedStopLossOrder {
  ...
  setCreateTime(createTime: DateTime | string): GuaranteedStopLossOrder {
  ...
  setState(state: OrderState): GuaranteedStopLossOrder {
    this.state = state;
    return this;
  }
  ...
  copy(): GuaranteedStopLossOrder {
    return new GuaranteedStopLossOrder()
      .setId(this.id.copy())
