...
describe('MarketOrderMarginCloseout', () => {
    ...
    it('test copy', () => {
        ...
        expectMarketOrderMarginCloseout(marketOrderMarginCloseout);
        expect(copyMarketOrderMarginCloseout).to.be.deep.equal(marketOrderMarginCloseout);
    });
    ...
    it('test to and from json', () => {
        ...
        const json: string = jsonConvert.serializeObject(marketOrderMarginCloseoutToJson);
        ...
        expect(marketOrderMarginCloseoutFromJson).to.be.deep.equal(marketOrderMarginCloseoutToJson);
    });
});

export const createMarketOrderMarginCloseout = () =>
    new MarketOrderMarginCloseout()
        .setReason(MarketOrderMarginCloseoutReason.REGULATORY_MARGIN_CALL_VIOLATION);

export const expectMarketOrderMarginCloseout = (marketOrderMarginCloseout: MarketOrderMarginCloseout) =>
    expect(marketOrderMarginCloseout.getReason()).to.be.equal(MarketOrderMarginCloseoutReason.REGULATORY_MARGIN_CALL_VIOLATION);
